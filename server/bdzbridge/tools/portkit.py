...
def _duplicate_titles() -> tuple[list[XTitle], dict[str, str]]:
    ...
    titles = [
        title("0xd1", "刑事コロンボ（４８）「幻の娼婦」", timedelta()),
        # the same episode, re-run a week later, one minute shorter and in a worse mode
        title("0xd2", "刑事コロンボ（48）「幻の娼婦」[再]", timedelta(days=7), duration=3540,
              quality_code=240, is_new=False, resume_sec=300),
        title("0xd3", "刑事コロンボ（４８）「幻の娼婦」", timedelta(days=14), duration=3600, protected=True),
        title("0xd4", "刑事コロンボ（４８）「幻の娼婦」", timedelta(days=21), duration=5400),
        title("0xe1", "名もなき番組", timedelta(days=1), duration=1800, size_mb=500),
        title("0xe2", "名もなき番組", timedelta(days=2), duration=1800, size_mb=500),
    ]
    summaries = {
        "0xd1": "ロサンゼルス市警のコロンボ警部が挑む。",
        "0xd2": "（再放送）ロサンゼルス市警のコロンボ警部が挑む。",
        "0xd3": "まったく別のあらすじ。",
        "0xd4": "拡大版のあらすじ。",
        "0xe1": "",
        "0xe2": "",
