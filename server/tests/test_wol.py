...
def test_normalize_mac_from_arp_output():
    assert normalize_mac("? (192.168.0.63) at f8:4e:17:00:00:00 on en0 ifscope [ethernet]") == "f8:4e:17:00:00:00"
    assert normalize_mac("192.168.0.63 dev eth0 lladdr F8:4E:17:00:00:00 REACHABLE") == "f8:4e:17:00:00:00"
    assert normalize_mac("192.168.0.63 (incomplete)") is None
