...
1152 バイトのゼロになります。観測した例（BDZ-FBT4100、地上デジタル 31 レコード）では、2 つの局の 3 サービスずつ、
計 6 レコードがゼロのままで、他の 22 サービスは PNG を持っていました。

**その局の番組を録画してもロゴは入りません。** ゼロだった 2 局の番組をそれぞれ録画した翌日、00:51 の
