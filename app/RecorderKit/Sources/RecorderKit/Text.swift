...
public enum Search {
    /// The form search text is stored and compared in: NFKC, then lower-cased, so that ＶＩＶＡＮＴ, VIVANT and
    /// vivant all match each other. The server case-folds instead, which differs only for a few Latin letters
