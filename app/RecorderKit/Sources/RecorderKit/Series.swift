...
public enum Series {
    ...
    /// The grouping key: NFKC, lower-cased, without spaces, so ＶＩＶＡＮＴ and VIVANT group together.
    ...
    /// Frames whose 「…」 part is the programme itself, as in 日曜劇場「VIVANT」, not an episode subtitle.
